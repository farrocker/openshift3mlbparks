...
$ oc create -f https://raw.githubusercontent.com/farrocker/openshift3mlbparks/master/mlbparks-template.json
$ oc new-app mlbparks
````
...
````
# oc create -f https://raw.githubusercontent.com/farrocker/openshift3mlbparks/master/mlbparks-template.json -n openshift
````
